 ...
 */
Drupal.behaviors.CMSSecondaryMenu = {
  attach: function (context, settings) {
 ...
 */
Drupal.behaviors.CMSJumpMenus = {
  attach: function (context, settings) {
    CMSJumpMenusAttach(context);
  }
};
...
function CMSJumpMenusAttach(context) {
